...
const adminGetDetailUserInfoById = async (req, res, next) => {
  logger.info('UserController::adminGetDetailUserInfoById::called');
  try {
    ...
    logger.info('UserController::adminGetDetailUserInfoById::success. Result: ' + JSON.stringify(result));
    return res.json({
      status: HttpCodeConstant.Success,
      message: ['Success'],
      data: {
    ...
    logger.info('UserController::adminGetDetailUserInfoById::error', e);
    return next(e);
  }
};
